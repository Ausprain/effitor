...
export type TargetRange = ReturnType<ReturnType<typeof getTargetRangeCtor>['fromRange']>
export type TargetCaret = ReturnType<TargetRange['toTargetCaret']>
export interface ValidTargetCaret extends TargetCaret {
  readonly anchorEtElement: Et.EtElement
  readonly anchorParagraph: Et.Paragraph
  readonly anchorTopElement: Et.Paragraph
}
export interface ValidTargetRange extends TargetRange {
  readonly startEtElement: Et.EtElement
  readonly startParagraph: Et.Paragraph
  readonly startTopElement: Et.Paragraph
  readonly endEtElement: Et.EtElement
  readonly endParagraph: Et.Paragraph
  readonly endTopElement: Et.Paragraph
}

interface _SelectionTarget {
  isCaret: () => boolean
}
export type SelectionTarget = TargetRange | TargetCaret | ValidTargetCaret | ValidTargetRange
...
export const getTargetRangeCtor = (etBody: Et.EditorBody) => {
  class TargetCaret implements _SelectionTarget {
    static readonly body = etBody
    declare private body: Readonly<Et.EditorBody>

    // 私有缓存成员
    private _etCaret?: EtCaret
    private _anchorEtElement?: Et.EtElement | null | undefined
    private _anchorParagraph?: Et.Paragraph | null | undefined
    private _anchorTopElement?: Et.Paragraph | null | undefined
    ...
    isValid(): this is ValidTargetCaret {
      ...
      this._isValid = this.body.isNodeInBody(this.container) && !!this.anchorParagraph
      return this._isValid
    }
    ...
    get anchorEtElement(): Et.EtElement | null {
      ...
      this._anchorEtElement = this.body.findEffectParent(this.container)
      return this._anchorEtElement
    }
    ...
    get anchorParagraph(): Et.Paragraph | null {
      ...
      this._anchorParagraph = this.body.findParagraph(this.anchorEtElement ?? this.container)
      return this._anchorParagraph
    }
    ...
    /** 光标是否在段落内开头 */
    get isCaretAtParagraphStart(): boolean {
    ...
    /** 光标是否在段落内结尾 */
    get isCaretAtParagraphEnd(): boolean {
    ...
    /** 光标是否在编辑区开头 */
    get isCaretAtBodyStart(): boolean {
  ...
  class TargetRange implements _SelectionTarget {
    ...
    static createCaret(container: Et.HTMLNode, offset: number) {
      ...
      return new TargetCaret(container, offset)
    }
    ...
    private get startCaret(): TargetCaret {
      ...
      this._startCaret = new TargetCaret(this.startNode, this.startOffset)
      return this._startCaret
    }
    ...
    private get endCaret(): TargetCaret {
      ...
      this._endCaret = new TargetCaret(this.endNode, this.endOffset)
      return this._endCaret
    }
     ...
     *  (仅当`指定效应节点`无子节点或选中`指定效应节点`开头时为 null)
     * * 该方法内部无缓存, 不要重复调用
     */
    ...
    get commonEtElement(): Et.EtElement | null {
      ...
      this._commonEtElement = this.body.findEffectParent(this.commonAncestor)
      return this._commonEtElement
    }
  ...
  Object.defineProperty(TargetCaret.prototype, 'body', {
    value: etBody,
  })
  Object.defineProperty(TargetRange.prototype, 'body', {
    value: etBody,
  })
