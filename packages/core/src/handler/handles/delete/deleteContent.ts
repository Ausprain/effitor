 ...
 */
export const deleteContent = createInputEffectHandle((ctx, pl) => {
 ...
 */
export const deleteContentBackward = createInputEffectHandle(function (ctx, pl) {
  ...
  return (
    // 光标在文本节点上
    checkBackspaceAtCaretDeleteText.call(this, ctx, tc, false)
    // 光标在段落开头?
 ...
 */
export const deleteContentForward = createInputEffectHandle(function (ctx, pl) {
  ...
  return (
    // 光标在文本节点上
    checkDeleteAtCaretDeleteText.call(this, ctx, tc, false)
    // 光标在段落末尾
