...
describe('integration', () => {
  test('deleteContent', async () => {
    ...
    expect(deleteContent(ctx.effectInvoker.getEtElCtor(p), ctx, { targetRange: ctx.selection.getTargetRange()! })).toBe(true)
  ...
  test('deleteContentBackward', async () => {
    ...
    expect(deleteContentBackward(ctx.effectInvoker.getEtElCtor(p), ctx, { targetRange: ctx.selection.getTargetRange()! })).toBe(true)
    expect(ctx.commandManager.handleAndUpdate()).toBe(true)
  ...
  test('deleteContentForward', async () => {
    ...
    expect(deleteContentForward(ctx.effectInvoker.getEtElCtor(p), ctx, { targetRange: ctx.selection.getTargetRange()! })).toBe(true)
    expect(ctx.commandManager.handleAndUpdate()).toBe(true)
