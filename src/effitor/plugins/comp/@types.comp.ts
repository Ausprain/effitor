...
declare module '@/effitor/@types' {
    interface EffectHandlerDeclaration {
         ...
         */
        createList: (ctx: Et.EditorContext, ordered: boolean, start?: number) => boolean
         ...
         */
        insertLi: (ctx: Et.EditorContext, currLi: HTMLLIElement, blank: boolean) => boolean
        /**
         * 末尾空li回车，删除该li并跳出列表
         */
        trimTail: (ctx: Et.EditorContext, currLi: HTMLLIElement) => boolean
    }
}