...
declare module '../../../effitor' {
    module Et {
        ...
        interface EffectHandlerDeclaration {
            ...
            /* -------------------------------------------------------------------------- */
            /** 插入标记符节点 */
            insertMarkNode: (ctx: Et.EditorContext, markType: MarkType) => Et.booleanvoid
            /** 将选区转为mark节点 */
            formatMark: (ctx: Et.EditorContext, markType: MarkType) => Et.booleanvoid
            /** 
             ...
             * ```
             */
            // deleteZeroWidthSpaceForMark: (ctx: Et.EditorContext, isBackward: boolean) => boolean

            /* -------------------------------------------------------------------------- */
            /*                              挂到EtMarkElement上                              */
            /* -------------------------------------------------------------------------- */
            /** 按下tab跳到标记节点的下一个#text开头, 若以zws开头则顺移 */
            tabToNextText: (ctx: Et.EditorContext) => boolean
